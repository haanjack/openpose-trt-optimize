...
MODEL_PROTOTXT = DATA_DIR + "pose_deploy.prototxt"
CAFFEMODEL = DATA_DIR + "pose_iter_584000.caffemodel"

# INPUT_LAYERS = ["data"]
# OUTPUT_LAYERS = ["prob"]
# MODEL_PROTOTXT = DATA_DIR + "googlenet.prototxt"
# CAFFEMODEL = DATA_DIR + "googlenet.caffemodel"
...
def main():
    ...
    print("Building and running GPU inference for OpenPose, N=4")
